...
/* First create an object of class FileWordRead: FileWordRead words = new FileWordsRead(in);                */
/* Next get an iterator over words in the input file by using method getIterator()*/
